...
function AboutEyantra() {
  return (
  <div>
      <div style={{  marginRight : 70, paddingBottom : 40, color : "#fff", paddingTop : 30,backgroundColor : "#000",width : "100vw"}} >   
      <div style={{padding : 0,padding: "0 4rem", paddingTop : 20,paddingBottom : 50,backgroundColor : "#000"}}>
          <p style={{fontSize : 26, margin : 0, lineHeight : 1, marginTop : 30, color : "#fff"}}>About E-yantra ?</p>
