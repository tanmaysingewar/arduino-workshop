  ...
  return (
    <div>
      ...
      <div style={{padding : 0,padding: "0 4rem", paddingTop : 20,paddingBottom : 50,backgroundColor : "#000"}}>
          <p style={{fontSize : 26, margin : 0, lineHeight : 1, marginTop : 30, color : "#fff",textAlign : "center"}}>Shedule for Our Day </p>
          <p style={{fontSize : 14, margin : 0, lineHeight : 2, color : "#fff",fontWeight : 400, marginTop : 10}}>
            <table align="center">
              ...
              <tr>
                ...
                <td><p style={{textAlign : "left"}}> Introduction to assembly of electronic components  </p></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><p style={{textAlign : "left"}}> Interfacing external perifals to Arduino Board and related Programing </p></td>
              </tr>
              <tr>
